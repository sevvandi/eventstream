...
The goal of *eventstream* is to extract and classify events in data streams. For details see [@eventstream].  The R scripts used in this paper are at  https://github.com/sevvandi/eventstream_paper .
